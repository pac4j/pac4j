 ...
 * {@link ProfileCreator} and {@link LogoutRequestBuilder} concepts.
 * 
 * @author Jerome Leleu
 * @since 1.9.0
 */
public abstract class IndirectClientV2<C extends Credentials, U extends CommonProfile> extends IndirectClient<C, U> {
    ...
    private LogoutRequestBuilder<U> logoutRequestBuilder = NoLogoutRequestBuilder.INSTANCE;
    ...
    public LogoutRequestBuilder<U> getLogoutRequestBuilder() {
        return logoutRequestBuilder;
    }

    public void setLogoutRequestBuilder(final LogoutRequestBuilder<U> logoutRequestBuilder) {
        if (this.logoutRequestBuilder == null || this.logoutRequestBuilder == NoLogoutRequestBuilder.INSTANCE) {
    ...
    public String toString() {
        return CommonHelper.toString(this.getClass(), "name", getName(), "callbackUrl", this.callbackUrl,
                ...
                "authenticator", this.authenticator, "profileCreator", this.profileCreator, "logoutRequestBuilder", this.logoutRequestBuilder);
    }
}
