...
/**
 * This interface is responsible to create a {@link UserProfile} from a {@link AuthenticationCredentials}.
...
public interface ProfileCreator {
     ...
     */
    Optional<UserProfile> create(CallContext ctx, AuthenticationCredentials credentials);
}
