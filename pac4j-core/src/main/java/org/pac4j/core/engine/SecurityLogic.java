 ...
 * @since 1.9.0
 */
public interface SecurityLogic<R extends Object> {
     ...
     * @param successAdapter the success adapter
     ...
     */
    R perform(WebContext context, Config config, SuccessAdapter<R> successAdapter, HttpActionAdapter<R> httpActionAdapter,
