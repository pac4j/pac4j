...
public final class MockIndirectClient extends IndirectClient {
    ...
    public MockIndirectClient(final String name, final RedirectionAction redirectAction,
    ...
    protected void internalInit(final boolean forceReinit) {
        setRedirectionActionBuilderIfUndefined(ctx -> Optional.of(redirectAction));
        setCredentialsExtractorIfUndefined(ctx -> returnCredentials.get());
