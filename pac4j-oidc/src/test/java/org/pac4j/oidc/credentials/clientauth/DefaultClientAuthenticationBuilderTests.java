...
public final class DefaultClientAuthenticationBuilderTests {
    ...
    @Test
    public void testBuildClientAuthenticationClientSecretBasic() throws Exception {
    ...
    @Test
    public void testBuildClientAuthenticationThrowsWhenPreferredNotSupported() throws Exception {
        val configuration = new OidcConfiguration();
        configuration.setClientId("myClient");
        configuration.setSecret("mySecret");
    ...
    @Test
    public void testGetClientAuthenticationRenewsExpiredPrivateKeyJwtWhenEnabled() throws Exception {
        val configuration = new OidcConfiguration();
        configuration.setClientId("myClient");
