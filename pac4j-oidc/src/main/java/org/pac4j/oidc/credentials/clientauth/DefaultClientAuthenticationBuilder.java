...
public class DefaultClientAuthenticationBuilder implements ClientAuthenticationBuilder {
    ...
    public void buildClientAuthentication() {
        val clientAuth = computeClientAuthentication();
        clientAuthenticationRef.set(clientAuth);
    }
    ...
    public ClientAuthentication getClientAuthentication() {
        ...
        if (privateKeyJwtConfig != null
            ...
            try {
                var newPvk = createPrivateKeyJWT(pvk.getClientID(), this.metadata.getTokenEndpointURI(),
