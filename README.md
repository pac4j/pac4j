...
**pac4j** (for Profile & Authentication Client for Java) is a general authentication / authorization engine to authenticate users, get their profiles and manage their authorizations in order to secure Java web applications. It is actually implemented by many frameworks and supports many authentication mechanisms.  
