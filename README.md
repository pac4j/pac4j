...
`pac4j` is a **Java security engine** to authenticate users, get their profiles and manage their authorizations to secure Java web applications. It's available under the Apache 2 license.
