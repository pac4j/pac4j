 ...
 * @since 1.1.0
 */
public class FacebookInfo extends JsonObject implements Serializable {
    
    private static final long serialVersionUID = 3237847960144528659L;
    ...
    public FacebookInfo(Object json) {
        super(json);
    }
