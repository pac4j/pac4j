...
/**
 * This class tests the {@link org.scribe.up.profile.facebook.FacebookMusicListen} class.
 * 
 * @author Jerome Leleu
 * @since 1.2.0
 */
public final class TestFacebookMusicListen extends TestCase {
    ...
    private static final String GOOD_JSON = "{\"id\": \"" + ID + "\", \"from\": { \"name\": \"" + NAME
                                            + "\", \"id\": \"" + ID + "\" }, \"start_time\": \"" + DATE
                                            + "\", \"end_time\": \"" + DATE + "\", \"publish_time\": \"" + DATE
                                            + "\", \"application\": { \"name\": \"" + NAME + "\", \"namespace\": \""
                                            + NAMESPACE + "\", \"id\": \"" + ID
                                            + "\" }, \"data\": { \"song\": { \"id\": \"" + ID + "\", \"url\": \"" + URL
                                            + "\", \"type\": \"" + TYPE + "\",  \"title\": \"" + TITLE
                                            + "\" }, \"musician\": { \"id\": \"" + ID + "\", \"url\": \"" + URL
                                            + "\", \"type\": \"" + TYPE + "\", \"title\": \"" + TITLE
                                            + "\" } , \"radio_station\": { \"id\": \"" + ID + "\", \"url\": \"" + URL
                                            + "\", \"type\": \"" + TYPE + "\", \"title\": \"" + TITLE
