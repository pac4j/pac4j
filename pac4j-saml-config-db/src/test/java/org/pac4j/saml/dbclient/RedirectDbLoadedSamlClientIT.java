...
/**
 * A concrete integration test of {@link DbLoadedSamlClient}, using the Redirect SAML binding.
 * 
 * Almost all code is taken from {@link RedirectSAML2ClientIT}.
 *  
 * @author jkacer
 */
public class RedirectDbLoadedSamlClientIT extends DbLoadedSamlClientIT {
    ...
    public void testCustomSpEntityIdForRedirectBinding() throws Exception {
        ...
        assertTrue(inflated.contains("<saml2:Issuer xmlns:saml2=\"urn:oasis:names:tc:SAML:2.0:assertion\">http://localhost:8080/callback</saml2:Issuer>"));
    }
