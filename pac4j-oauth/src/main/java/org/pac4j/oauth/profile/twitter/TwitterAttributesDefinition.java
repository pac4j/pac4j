...
public class TwitterAttributesDefinition extends OAuthAttributesDefinition {
    ...
    public TwitterAttributesDefinition() {
        primary(CONTRIBUTORS_ENABLED, Converters.booleanConverter);
        primary(CREATED_AT, TwitterConverters.dateConverter);
        primary(DEFAULT_PROFILE, Converters.booleanConverter);
        primary(DEFAULT_PROFILE_IMAGE, Converters.booleanConverter);
        primary(DESCRIPTION, Converters.stringConverter);
        primary(FAVOURITES_COUNT, Converters.integerConverter);
        primary(FOLLOW_REQUEST_SENT, Converters.booleanConverter);
        primary(FOLLOWERS_COUNT, Converters.integerConverter);
        primary(FOLLOWING, Converters.booleanConverter);
        primary(FRIENDS_COUNT, Converters.integerConverter);
        primary(GEO_ENABLED, Converters.booleanConverter);
        primary(IS_TRANSLATOR, Converters.booleanConverter);
        primary(LANG, Converters.localeConverter);
        primary(LISTED_COUNT, Converters.integerConverter);
        primary(LOCATION, Converters.stringConverter);
        primary(NAME, Converters.stringConverter);
        primary(NOTIFICATIONS, Converters.booleanConverter);
        primary(PROFILE_BACKGROUND_COLOR, Converters.colorConverter);
        primary(PROFILE_BACKGROUND_IMAGE_URL, Converters.urlConverter);
        primary(PROFILE_BACKGROUND_IMAGE_URL_HTTPS, Converters.urlConverter);
        primary(PROFILE_BACKGROUND_TILE, Converters.booleanConverter);
        primary(PROFILE_IMAGE_URL, Converters.urlConverter);
        primary(PROFILE_IMAGE_URL_HTTPS, Converters.urlConverter);
        primary(PROFILE_LINK_COLOR, Converters.colorConverter);
        primary(PROFILE_SIDEBAR_BORDER_COLOR, Converters.colorConverter);
        primary(PROFILE_SIDEBAR_FILL_COLOR, Converters.colorConverter);
        primary(PROFILE_TEXT_COLOR, Converters.colorConverter);
        primary(PROFILE_USE_BACKGROUND_IMAGE, Converters.booleanConverter);
        primary(PROTECTED, Converters.booleanConverter);
        primary(SCREEN_NAME, Converters.stringConverter);
        primary(SHOW_ALL_INLINE_MEDIA, Converters.booleanConverter);
        primary(STATUSES_COUNT, Converters.integerConverter);
        primary(TIME_ZONE, Converters.stringConverter);
        primary(URL, Converters.stringConverter);
        primary(UTC_OFFSET, Converters.integerConverter);
