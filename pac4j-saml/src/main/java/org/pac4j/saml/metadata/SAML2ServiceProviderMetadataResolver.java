...
public class SAML2ServiceProviderMetadataResolver implements SAML2MetadataResolver {
	...
	public SAML2ServiceProviderMetadataResolver(final String spMetadataPath, final WritableResource spMetadataResource,
			final String callbackUrl, @Nullable final String spEntityId, final boolean forceSpMetadataGeneration,
			final CredentialProvider credentialProvider) {
