 ...
 * @since 3.4.0
 */
public class SAML2CredentialsExtractorLegacy implements CredentialsExtractor {
    ...
    public SAML2CredentialsExtractorLegacy(final SAML2Client client) {
    ...
    protected Optional<Credentials> receiveLogin(final SAML2MessageContext samlContext, final WebContext context) {
        ...
        val credentials = (SAML2InternalCredentials) this.profileHandler.receive(samlContext);
