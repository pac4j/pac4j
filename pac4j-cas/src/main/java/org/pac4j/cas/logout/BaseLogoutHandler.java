...
/**
 * This class is a base logout handler, from which the session tracking and destruction must be implemented.
 * 
 * @author Jerome Leleu
 * @since 1.4.0
 */
public abstract class BaseLogoutHandler implements LogoutHandler {
