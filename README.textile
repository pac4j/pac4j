...
| Facebook | Github | Google | LinkedIn | Twitter | Windows Live | Yahoo |

Look at the "description of the providers and profiles":https://github.com/leleuj/scribe-up/wiki/Description-of-providers-and-profiles.
...
ScribeUP is tested by 143 unit tests and also 7 integration tests on OAuth providers by simulating complete authentication processes (using the "HtmlUnit":http://htmlunit.sourceforge.net/ library).
