...
The last release version is 1.2.0-RC1.
The current version : 1.3.0-SNAPSHOT is under development. It's available on "Sonatype snapshots repository":https://oss.sonatype.org/content/repositories/snapshots/.
