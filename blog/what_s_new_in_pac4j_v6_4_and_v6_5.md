...
- integration tests have been turned into unit tests
...
It prefers automatic registration (sending the entity statement as `client_assertion`); otherwise it falls back to explicit registration via `federation_registration_endpoint`,
