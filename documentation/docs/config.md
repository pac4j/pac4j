...
| `couch.url`, `couch.username`, `couch.password`, `couch.databaseName` and `couch.passwordEncoder` | To define a `CouchAuthenticator` based on the provided properties and named `couch` or `couch.N` |
