...
| `dcqlQuery` | | The DCQL query, as a JSON object in a string: which credentials, of which format, with which claims. Presentation exchange is not supported |
